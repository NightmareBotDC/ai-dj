	...
	<div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
		<div class="relative flex h-16 items-center justify-between">
			<div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
				<button
					type="button"
					class="inline-flex items-center justify-center rounded-md p-2 text-white hover:text-gray-400 font-semibold focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
			...
			<div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
				<div class="flex flex-shrink-0 items-center">
					<img class="block h-8 w-auto rounded-md lg:hidden" src="/logo.png" alt="AzidoDJ" />

					<img class="hidden h-8 w-auto rounded-md lg:block" src="/logo.png" alt="AzidoDJ" />

					<h2 class="pl-2 text-white font-bold">AzidoDJ</h2>
				</div>
				...
				>
					{#if user}
						<button
							type="button"
							class="rounded-full p-1 text-white hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
					...
					<div class="relative left-0">
						...
						{:else}
							<button
								type="button"
								on:click={login}
								class="rounded-full p-1 font-semibold text-white hover:text-gray-400 focus:outline-none"
							>
								Login
							</button>
						{/if}
